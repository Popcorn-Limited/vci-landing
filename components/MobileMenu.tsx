                    ...
                    <div className={`flex flex-col gap-10`}>
                        <div className={`flex justify-between`}>
                            <div className={`flex flex-col gap-4`}>
                                ...
                                <a className={`text-[#645F4B]`} href="https://google.com/">Popcorn</a>
                                <a className={`text-[#645F4B]`} href="https://google.com/">Whitepaper</a>
                            </div>
                        ...
                        <div className={`flex gap-2`}>
                            <a className={`p-4 bg-[#141416] opacity-80 rounded-[50%]`} href="https://google.com/">
                                <TwitterIcon color={'#D7D7D7'} size={'24px'} />
                            </a>
                            <a className={`p-4 bg-[#141416] opacity-80 rounded-[50%]`} href="https://google.com/">
                                <DiscordIcon color={'#D7D7D7'} size={'24px'} />
                            </a>
                            <a className={`p-4 bg-[#141416] opacity-80 rounded-[50%]`} href="https://google.com/">
                                <TelegramIcon color={'#D7D7D7'} size={'24px'} />
                            </a>
                        </div>
                    </div>
                </div>
